...
[ExtractorType(ExtractorTypes.LitecoinWallet)]
public class LitecoinWalletExtractor : ExtractorBase,
    ...
    IFileSizeBiggerZeroHashOutputFileCheckerTrait
{
    ...
    public override string Name => "Litecoin";
    ...
    public async Task<bool?> ExtractHashesFromFileAsync(string filePath)
    {
        ...
        var relativePath = $@"_Hashout\Litecoin_Extraction_{Path.GetFileNameWithoutExtension(filePath)}_{timestamp}.txt";
