...
public class TrueCryptBootPartitionExtractor : ExtractorBase,
    ...
    IFileSizeBiggerZeroHashOutputFileCheckerTrait
{
    ...
    public override string Name => "TrueCrypt (Boot-Partition)";
    ...
    public async Task<bool?> ExtractHashesFromFileAsync(string filePath)
    {
        ...
        var relativePath = $@"_Hashout\TrueCrypt_BootPartition_Extraction_{Path.GetFileNameWithoutExtension(filePath)}_{timestamp}.txt";
