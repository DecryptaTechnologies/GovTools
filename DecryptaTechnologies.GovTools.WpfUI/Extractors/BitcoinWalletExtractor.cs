...
[ExtractorType(ExtractorTypes.BitcoinWallet)]
public class BitcoinWalletExtractor : ExtractorBase,
    ...
    IFileSizeBiggerZeroHashOutputFileCheckerTrait
{
    ...
    public override string? ImageUrl => "/Resources/extractor-bitcoin.png";
    ...
    public async Task<bool?> ExtractHashesFromFileAsync(string filePath)
    {
        ...
        var relativePath = $@"_Hashout\Bitcoin_Extraction_{Path.GetFileNameWithoutExtension(filePath)}_{timestamp}.txt";
